...
page 90902 "ocpfPostedReturnShipments"
{
    PageType = API;
    Caption = 'Posted return shipments (goods returned to vendor).';
    APIPublisher = 'OnlyCopilotFans';
    APIGroup = 'ocpf_purchasing';
    APIVersion = 'v3.0';
    EntityName = 'ocpfPostedReturnShipment';
    EntitySetName = 'ocpfPostedReturnShipments';
                ...
                field(vendorAuthorizationNo; Rec."Vendor Authorization No.")
                    {
                        ...
                        ToolTip = 'Specifies the Vendor Authorization No..';
                        ApplicationArea = All;
                }
