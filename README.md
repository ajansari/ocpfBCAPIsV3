...
**OCPF APIs** is a Microsoft Dynamics 365 Business Central extension that exposes over 100 of the most commonly used standard BC tables as OData v4 API endpoints. It is designed to be a comprehensive, ready-to-use API layer for integrations, reporting tools, and external applications that need reliable, structured access to Business Central data without requiring custom development per table.
