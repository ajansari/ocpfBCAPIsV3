...
page 90885 "ocpfPostedReturnReceiptLines"
{
    PageType = API;
    Caption = 'Lines of posted return receipts.';
    APIPublisher = 'OnlyCopilotFans';
    APIGroup = 'ocpf_sales';
    APIVersion = 'v3.0';
    EntityName = 'ocpfPostedReturnReceiptLine';
    EntitySetName = 'ocpfPostedReturnReceiptLines';
