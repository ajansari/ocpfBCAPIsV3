...
page 90879 "ocpfPostedSalesInvoiceLines"
{
    PageType = API;
    Caption = 'Lines of posted sales invoices.';
    APIPublisher = 'OnlyCopilotFans';
    APIGroup = 'ocpf_sales';
    APIVersion = 'v3.0';
    EntityName = 'ocpfPostedSalesInvoiceLine';
    EntitySetName = 'ocpfPostedSalesInvoiceLines';
