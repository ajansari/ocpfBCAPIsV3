...
page 90998 "ocpfServiceCrMemoHeaders"
{
    PageType = API;
    Caption = 'Posted Service Credit Memos — headers of posted service credit memos. Read-only.';
    APIPublisher = 'OnlyCopilotFans';
    APIGroup = 'ocpf_serviceManagement';
    APIVersion = 'v3.1';
    EntityName = 'ocpfServiceCrMemoHeader';
    EntitySetName = 'ocpfServiceCrMemoHeaders';
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                {
                    Caption = 'Order Time';
                    ToolTip = 'Specifies the Order Time.';
                    ApplicationArea = All;
                }
                ...
                field(serviceTimeHours; Rec."Service Time (Hours)")
                {
                    ...
                    ToolTip = 'Specifies the Service Time (Hours).';
                    ApplicationArea = All;
                }
                field(responseDate; Rec."Response Date")
                {
                    Caption = 'Response Date';
                    ToolTip = 'Specifies the Response Date.';
                    ApplicationArea = All;
                }
                field(responseTime; Rec."Response Time")
                {
                    Caption = 'Response Time';
                    ToolTip = 'Specifies the Response Time.';
                    ApplicationArea = All;
                }
                ...
                field(finishingDate; Rec."Finishing Date")
                {
                    ...
                    ToolTip = 'Specifies the Finishing Date.';
                    ApplicationArea = All;
                }
                field(finishingTime; Rec."Finishing Time")
                {
                    Caption = 'Finishing Time';
                    ToolTip = 'Specifies the Finishing Time.';
                    ApplicationArea = All;
                }
                ...
                field(notifyCustomer; Rec."Notify Customer")
                {
                    ...
                    ToolTip = 'Specifies the Notify Customer.';
                    ApplicationArea = All;
                }
                ...
                field(warningStatus; Rec."Warning Status")
                {
                    ...
                    ToolTip = 'Specifies the Warning Status.';
                    ApplicationArea = All;
                }
                ...
                {
                    Caption = 'Contract No.';
                    ToolTip = 'Specifies the Contract No..';
                    ApplicationArea = All;
                }
                ...
                field(shipToPhone2; Rec."Ship-to Phone 2")
                {
                    ...
                    ToolTip = 'Specifies the Ship-to Phone 2.';
                    ApplicationArea = All;
                }
