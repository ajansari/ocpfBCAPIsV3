...
page 90999 "ocpfServiceCrMemoLines"
{
    PageType = API;
    Caption = 'Posted Service Credit Memo Lines — lines of posted service credit memos. Read-only.';
    APIPublisher = 'OnlyCopilotFans';
    APIGroup = 'ocpf_serviceManagement';
    APIVersion = 'v3.1';
    EntityName = 'ocpfServiceCrMemoLine';
    EntitySetName = 'ocpfServiceCrMemoLines';
        ...
        area(content)
        {
            repeater(Group)
            {
                ...
                field(serviceItemSerialNo; Rec."Service Item Serial No.")
                {
                    ...
                    ToolTip = 'Specifies the Service Item Serial No..';
                    ApplicationArea = All;
                }
