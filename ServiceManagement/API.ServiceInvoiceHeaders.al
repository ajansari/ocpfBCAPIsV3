...
page 90996 "ocpfServiceInvoiceHeaders"
{
    PageType = API;
    Caption = 'Posted Service Invoices — headers of posted service invoices. Read-only.';
    APIPublisher = 'OnlyCopilotFans';
    APIGroup = 'ocpf_serviceManagement';
    APIVersion = 'v3.1';
    EntityName = 'ocpfServiceInvoiceHeader';
    EntitySetName = 'ocpfServiceInvoiceHeaders';
