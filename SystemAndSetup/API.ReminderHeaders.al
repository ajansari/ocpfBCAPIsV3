...
page 90933 "ocpfReminderHeaders"
{
    PageType = API;
    Caption = 'Reminder headers — open reminder documents sent to customers with overdue balances.';
    APIPublisher = 'OnlyCopilotFans';
    APIGroup = 'ocpf_systemAndSetup';
    APIVersion = 'v3.0';
    EntityName = 'ocpfReminderHeader';
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field(reminderTermsCode; Rec."Reminder Terms Code")
                    {
                        ...
                        ToolTip = 'Specifies the Reminder Terms Code.';
                        ApplicationArea = All;
                }
                ...
                field(reminderLevel; Rec."Reminder Level")
                    {
                        Caption = 'Reminder Level';
                        ToolTip = 'Specifies the Reminder Level.';
                        ApplicationArea = All;
                }
                ...
                field(useHeaderLevel; Rec."Use Header Level")
                    {
                        Caption = 'Use Header Level';
                        ToolTip = 'Specifies the Use Header Level.';
                        ApplicationArea = All;
                }
                field(addFeePerLine; Rec."Add. Fee per Line")
                    {
                        Caption = 'Add. Fee per Line';
                        ToolTip = 'Specifies the Add. Fee per Line.';
                        ApplicationArea = All;
                }
                field(postAddFeePerLine; Rec."Post Add. Fee per Line")
                    {
                        Caption = 'Post Add. Fee per Line';
                        ToolTip = 'Specifies the Post Add. Fee per Line.';
                        ApplicationArea = All;
                }
                ...
                field(emailText; Rec."Email Text")
                    {
                        Caption = 'Email Text';
                        ToolTip = 'Specifies the Email Text.';
                        ApplicationArea = All;
                }
                ...
                field(reminderAutomationCode; Rec."Reminder Automation Code")
                    {
                        Caption = 'Reminder Automation Code';
                        ToolTip = 'Specifies the Reminder Automation Code.';
                        ApplicationArea = All;
                }
